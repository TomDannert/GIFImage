...
function GetPixelSize(Format: TImageFormat; Width, Height: Integer): Integer;
begin
  case Format of
    ifIndex8:
    begin
...
function NewImage(Width, Height: Integer; Format: TImageFormat; var Image: TImageData): Boolean;
begin
...
procedure FillCustomPalette(Pal: PPalette32; Entries: Integer; RBits, GBits, BBits: Byte; Alpha: Byte = $FF);
var
...
begin
  case BytesPerPixel of
    ...
    4: PCardinal(Dest)^ := PCardinal(Src)^;
  end;
end;
...
begin
  ...
  SrcPtr := @PByteArray(Image.Bits)[SrcY * (Image.Width * Bpp) + SrcX * Bpp];
  ...
  try
    ...
    begin
      ...
      begin
        ...
        begin
          AlphaColorToPixel(PAlphaColorRec(SrcPtr).Color, DstPtr, Bitmap.PixelFormat);
          Inc(SrcPtr, Bpp);
          Inc(DstPtr);
        end;
      end
...
var
  I, J, ImageWidthBytes, RectWidthBytes, Bpp: Integer;
    ...
    begin
      ...
      begin
        case Bpp of
          ...
          4: FillMemoryCardinal(LinePointer, RectWidthBytes, PCardinal(FillColor)^);
        else
...
begin
  ...
  begin
    ...
    FillMemoryCardinal(AFrame.Bits, AFrame.Size, BGColor);
    while First > 0 do
    begin
  ...
  (
    ...
    begin
      ...
      begin
        ...
        begin
          Sleep(Max(0, FFrames[FrameIndex].Delay - AniTimer.ElapsedMilliseconds));
        end;
